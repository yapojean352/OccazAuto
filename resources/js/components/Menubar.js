         ...
         <>
          <header className="bar-fixed">
               <nav className="navbar">
                    ...
                    <Link to='/OccazAuto/public/' className="navbar-logo" onClick={closeMobileMenu}>OccazAuto</Link>
                    </div>
                   ...
                   <ul className={ click ? 'nav-menu active' : 'nav-menu '}>
                       ...
                       <li className='nav-item'> 
                          <Link to='/OccazAuto/public/plus' className='nav-links' onClick={closeMobileMenu}>
                         Plus
                           </Link>
                       </li>
                       <li className='nav-item'> 
